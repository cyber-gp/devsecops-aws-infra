...
resource "aws_subnet" "private_app_subnet_az1" {
  ...
  tags = {
    Name = "${var.environment}-${var.project_name}-private-app-subnet-az1"
  }
}
...
resource "aws_subnet" "private_app_subnet_az2" {
  ...
  tags = {
    Name = "${var.environment}-${var.project_name}-private-app-subnet-az2"
  }
}
...
resource "aws_subnet" "private_data_subnet_az1" {
  ...
  tags = {
    Name = "${var.environment}-${var.project_name}-private-data-subnet-az1"
  }
}
...
resource "aws_subnet" "private_data_subnet_az2" {
  ...
  tags = {
    Name = "${var.environment}-${var.project_name}-private-data-subnet-az2"
  }
}