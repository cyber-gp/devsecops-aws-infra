...
export S3_URI='s3://nest-terraform-remote-state-dev/project-1/V1__nest.sql'
export RDS_ENDPOINT='dev-nest-db.cbgq6s0gc62q.us-east-2.rds.amazonaws.com'
export RDS_DB_NAME='applicationdb'
export RDS_DB_USERNAME='admin'
export FLYWAY_VERSION='11.20.2'
export SECRET_NAME='dev-nest-secret'
...
# Create the SQL directory for migrations (as stated in the flywheel documentation)
sudo mkdir -p sql
